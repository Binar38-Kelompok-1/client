const Selesai = () => {
    return (
        <>
            ...
            {/* <% if (data.length == 0) { %> */}
                <h1 className="text-center nodata">Tidak Ada Laporan yang Sudah Dibalas!</h1>
            {/* <% } else { %> */}
                    ...
                    <tbody>
                        ...
                        {/* <% data.forEach(el => { %> */}
                            <tr>
                                ...
                                <td><a className="btn btn-primary" href="/admin/selesai/<%= el.id_laporan %>"><i className="fa-solid fa-circle-info"></i></a></td>
                            </tr>                  
                        {/* <% }); %> */}
                    </tbody>
                    <tfoot>
