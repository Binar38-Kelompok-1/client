          ...
          <tr>
            ...
            <td>
              <a
                ...
                href="/admin/masyarakat/<%= el.id %>"
              >
                <i className="fa-solid fa-circle-info"></i>
              </a>
              <a
                className="btn btn-success"
                href="/admin/masyarakat/<%= el.id %>/edit"
              >
                <i className="fa-solid fa-pen-to-square"></i>
              </a>
              <a
                className="btn btn-danger"
                href="/admin/masyarakat/<%= el.id %>/delete"
                onClick="return confirm('Apakah Anda Ingin Menghapus <%=el.nama%>?')"
              >
